...
describe('RemoveItemComponent', () => {
  ...
  let mockRemoveItemService;
  let mockDataService

  beforeEach(async(() => {

    mockRemoveItemService = sinon.createStubInstance(RemoveItemService);
    mockRemoveItemService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: RemoveItemService, useValue: mockRemoveItemService },
