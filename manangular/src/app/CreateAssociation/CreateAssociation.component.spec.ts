...
import { CreateAssociationComponent } from './CreateAssociation.component';
...
describe('CreateAssociationComponent', () => {
  ...
  let mockCreateAssociationService;
  let mockDataService

  beforeEach(async(() => {

    mockCreateAssociationService = sinon.createStubInstance(CreateAssociationService);
    mockCreateAssociationService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CreateAssociationService, useValue: mockCreateAssociationService },
